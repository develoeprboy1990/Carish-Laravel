...
Route::get('user/check-sms', 'User\AuthController@checkSMS')->name('check-sms');
...
// ONLY LOGGED IN USERS.
  ...
  Route::post('/check-last-phone-change', 'CustomerController@checkLastPhoneChange')->name('check-last-phone-change');
  ...
  Route::post('check-old-password-business', 'CustomerController@checkOldPasswordBusiness')->name('check-old-password-business');
...
Route::group(['namespace' => 'Admin', 'middleware' => 'admin'], function () {
  ...
  //Car Management::Car Verients Import
  Route::get('admin/empty-carvariants', 'YearController@emptyCarVariants')->middleware('roles:car_ads');
  Route::get('admin/empty-makemodels', 'YearController@emptyMakeModels')->middleware('roles:car_ads');
  Route::get('admin/empty-versions', 'YearController@emptyVersions')->middleware('roles:car_ads');

  Route::get('admin/car-varients', 'YearController@carVariants')->middleware('roles:car_ads');
  Route::post('admin/upload-car-variants', 'YearController@uploadCarVariantsFile')->middleware('roles:car_management');
  Route::get('admin/import-car-variants/{id}', 'YearController@importCarVariantsData')->middleware('roles:car_management');
  Route::get('admin/update-makes', 'YearController@updateMakes')->middleware('roles:car_ads');
  Route::get('admin/update-versions', 'YearController@updateVersions')->middleware('roles:car_ads');
