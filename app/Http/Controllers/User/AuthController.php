      ...
      if($role == 'business') {
        ...
        if (!$resultJson->success) {
            return redirect()->back()
                ->withErrors(['captcha' => Lang::get('postCarAdPage.captchaConfirm')])
                ->withInput();
        }
    }
...
/*   public function redirectToProvider()
  ...
  public function verifyCustomerContactXXXX(Request $request)
  {
        $finalAaary = array();
        if (request()->ajax()) {
            ...
            $url       = "https://send.messagecloud.io/sms";
    ...
    if (request()->ajax()) {
        ...
        if (!$resultJson->success) {
            ...
            return response()->json([
                'status' => 'error',
                'errors' => ['captcha' => [__('signUp.captchaConfirm')]]
            ], 422);
        }
        ...
        try {
            ...
            $twilio->messages->create(
                "+372" . $customer_contact, // To number
                [
