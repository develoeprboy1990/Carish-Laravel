      ...
      <div class="signInbg box-shadow bg-white p-md-5 p-sm-4 p-3 pt-4 rounded">
        ...
        <div class="tab-content signup-form">
          ...
          <form class="" action="" method="POST" id="myForm">
              ...
              <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-individual">
                ...
                <div class="row">
                  ...
                  <div class="col-11">
                    <select class="form-control selectpicker select-cont"   name="prefered_language"> 
                      <option data-content='<span class="flag-icon flag-icon-ee"></span> {{__("signUp.estonianLanguage")}}' value="1">{{__('signUp.estonianLanguage')}} </option>
                      <option data-content='<span class="flag-icon flag-icon-us"></span> {{__("signUp.englishLanguage")}}' value="2">{{__('signUp.englishLanguage')}}</option>
                      <option  data-content='<span class="flag-icon flag-icon-ru"></span> {{__("signUp.russianLanguage")}}' value="3">{{__('signUp.russianLanguage')}}</option>
                    </select> 
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-1"></div>
                <div class="col-11">
                   <input type="submit" class="btn rounded-0 btn-block themebtn1 signIn-btn individual"  value="{{__('signUp.buttonText')}}">
                </div>
              </div> 
          ...
          @endif
            <form class="" action="" method="POST" id="myForm2">
              ...
              <input type="hidden" name="g-recaptcha-response" id="g-recaptcha-response-business">
              {{-- Company Name --}}
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  <div class="col-1" style="max-height: 46.5px;">
              ...
              <div class="form-group mb-4 align-items-center">
                <div class="row">
                  ...
                  <div class="col-11">
                     <select class="form-control selectpicker select-cont" name="prefered_language">
                        <option data-content='<span class="flag-icon flag-icon-ee"></span> {{__("signUp.estonianLanguage")}}' value="1">Eesti keel </option>
                        <option data-content='<span class="flag-icon flag-icon-us"></span> {{__("signUp.englishLanguage")}}' value="2">English</option>
                        <option  data-content='<span class="flag-icon flag-icon-ru"></span> {{__("signUp.russianLanguage")}}' value="3">русский язык</option>
                      </select> 
                  </div>
                </div>
              </div>
        ...
        <div class="modal-content sms-alert-content">
            ...
            <form method="post" name="sms_verify_form" id="sms_verify_form" action="{{route('verify-contact-process')}}" target="_blank">
                ...
                <div class="modal-body sms-modal-body">
                   <div class="captcha-error-message text-danger text-center mb-3" style="display: none;"></div>
...
$(document).ready(function(){
  ...
  $(document).on('click', '#contact-verify_XXXX', function() { 
  ...
  $('a[href="#company"]').on('click', function() {
    initBusinessRecaptcha();
  });
  ...
  function initBusinessRecaptcha() {
      grecaptcha.ready(function() {
          grecaptcha.execute('{{ env('RECAPTCHA_SITE_KEY') }}', {action: 'business_signup'}).then(function(token) {
              $("#g-recaptcha-response-business").val(token);
          });
      });
  }
</script>
