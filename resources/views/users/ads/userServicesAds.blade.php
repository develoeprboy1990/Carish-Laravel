                        ...
                        <div class="row align-items-sm-center">
                          <div class="col-lg-7 col-md-8 col-sm-8 mb-0 editProfile actionbtn ">
                            <ul class="list-unstyled mb-0">
                              ...
                              <li class="list-inline-item"><a href="" class="border d-inline-block px-sm-3 px-2 py-1 rounded remove-ad" data-id="{{$service->id}}">{{__('dashboardMyAds.statusPendingRemove')}} <em class="ml-1 fa fa-trash"></em></a></li>
