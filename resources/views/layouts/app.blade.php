...
<head>
    ...
    <script async src="https://pagead2.googlesyndication.com/pagead/js/adsbygoogle.js?client=ca-pub-1486808281787848"
                        ...
                        <ul class="d-inline-block list-unstyled mb-0">
                            ...
                            <li class="dropdown list-inline-item logIn-item">
                                ...
                                <div class="dropdown-menu dropdown-menu-right dropdown-top-border cstm-dropdown-menu" aria-labelledby="loginDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('logoff') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();"> {{ __('header.signOut') }}</a>
                    ...
                    <div class="collapse navbar-collapse" id="collapsibleNavbar">
                        <ul class="navbar-nav ml-auto">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('findusedcars') }}" class="d-flex dropdown-item">
                                        ...
                                        <div class="ml-2 pl-1">
                                            ...
                                            <p class="mb-0">{{ __('header.findUsedCarsDetailText') }}</p>
                                        </div>
                                    </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu"><!-- {{ route('findautoparts') }} -->
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <!-- {{url('find-car-services/'.$ps->slug)}} -->
                                    <a href="#" id="ps_{{$ps->slug}}" class="d-flex dropdown-item">
                                        <span class="mb-0">
                ...
                <div class="col-xl-auto col-lg-auto col-md-3 col-sm-2 header-btn text-right d-none d-md-block">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-top-border cstm-dropdown-menu" style="top: 37px;">
                            <a href="{{ url('user/post-car-ad') }}" class="dropdown-item">{{ __('header.sellCar') }}</a>
                            <!-- {{ route('sparepartads') }} -->
                            <a href="#" class="dropdown-item">{{ __('header.sellSparePart') }}</a>
                            @if(@Auth::guard('customer')->user()->customer_role == 'business')
                            <!-- {{ route('offerservices') }} -->
                            <a href="#" class="dropdown-item">{{ __('header.offerService') }}</a>
                            @endif
                        </div>
                    </div>
                </div>
